// Realistic mock data used across the app until the backend is connected.
const getStoredUser = () => {
...
export const currentUser = getStoredUser() || defaultUser;
export const alarms = [
    {
        id: "a1",
...
export const focusTrend = [
    { date: "Jun 12", score: 62 }, { date: "Jun 16", score: 68 }, { date: "Jun 20", score: 65 },
    { date: "Jun 24", score: 74 }, { date: "Jun 28", score: 71 }, { date: "Jul 2", score: 79 },
    { date: "Jul 6", score: 83 }, { date: "Jul 10", score: 84 },
];
...
export const heatmap = Array.from({ length: 12 }, (_, w) => Array.from({ length: 7 }, (_, d) => {
